...
<body class="min-h-screen font-sans relative bg-gradient-to-b from-green-50 to-orange-50">
  ...
  <div class="relative z-10 w-11/12 sm:w-96 mx-auto mt-12 bg-white/90 p-8 rounded-3xl shadow-2xl text-center">
    ...
    <!-- Welcome Message -->
    <h2 class="mt-4 text-3xl sm:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-yellow-400 to-pink-500">
      Welcome to Tote_Tales
    </h2>

    <p class="text-lg sm:text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 mb-6">
      Carry Your Story
    </p>
  ...
  <div class="flex flex-col items-center gap-8 mt-12 p-6 bg-white/90 rounded-2xl shadow-2xl w-80 mx-auto">
    ...
    <a href="{{ route('login') }}"
       class="w-full text-center bg-green-600 text-white py-3 text-lg font-medium rounded-lg hover:bg-green-700 transition">
      Login
    </a>

    <a href="{{ route('register') }}"
       class="w-full text-center bg-orange-500 text-white py-3 text-lg font-medium rounded-lg hover:bg-orange-600 transition">
      Register
    </a>

    <a href="{{ route('visitor') }}"
       class="w-full text-center border border-green-500 text-green-600 py-3 text-lg font-medium rounded-lg hover:bg-green-50 transition">
      View As Visitor
    </a>
